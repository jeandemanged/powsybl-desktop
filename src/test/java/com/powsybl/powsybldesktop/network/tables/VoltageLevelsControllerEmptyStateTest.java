 ...
 */
class VoltageLevelsControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        assertEquals(0, controller.currentVoltageLevels.size());
        assertEquals(0, controller.voltageLevelsTableView.getItems().size());
    }
}

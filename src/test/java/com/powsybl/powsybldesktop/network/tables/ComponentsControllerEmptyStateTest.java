 ...
 */
class ComponentsControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        assertEquals(0, controller.currentComponents.size());
        assertEquals(0, controller.componentsTableView.getItems().size());
    }
}

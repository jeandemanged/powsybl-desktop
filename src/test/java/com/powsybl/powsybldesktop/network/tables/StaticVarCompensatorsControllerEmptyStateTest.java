 ...
 */
class StaticVarCompensatorsControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        assertEquals(0, controller.currentItems.size());
        assertEquals(0, controller.staticVarCompensatorsTableView.getItems().size());
    }
}

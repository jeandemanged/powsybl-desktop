 ...
 */
class SubstationsTableControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        assertEquals(0, controller.currentSubstations.size());
        assertEquals(0, controller.substationsTableView.getItems().size());
    }
}

 ...
 */
class ShuntCompensatorsControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        ...
        assertEquals(0, controller.shuntCompensatorsTableView.getItems().size());
    }
}

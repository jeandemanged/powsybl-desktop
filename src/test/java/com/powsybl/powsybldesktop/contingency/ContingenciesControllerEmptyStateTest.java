 ...
 */
class ContingenciesControllerEmptyStateTest extends AbstractHeadlessApplicationTest {
    ...
    void noExceptionWhenNoNetworkIsSelected() {
        assertEquals(0, controller.contingencyListsListView.getItems().size());
        assertEquals(0, controller.contingenciesTableView.getItems().size());
    }
}
